...
do
    ...
    rm -rf -- ./*
    PICO_SDK_PATH="${PICO_SDK_PATH}" cmake .. -DPICO_BOARD=$board_name -DSECURE_BOOT_PKEY=${SECURE_BOOT_PKEY} -DVIDPID=Yubikey5 -DENABLE_PQC=1 -DPICO_DEFAULT_WS2812_PIN=16
    make -j`nproc`
